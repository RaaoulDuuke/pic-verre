...
<div class="modal-content">
	...
	<div class="modal-body">
		...
		<form id="orderForm" action="https://mon-compte.pic-verre.fr/edit/pick.www.edit.php" method="post" class="needs-validation" novalidate >
		
			<h4 class="mb-1">1. Mon adresse</h4>
			<p style="font-size:95%;">Saisissez votre adresse pour connaitre la date de votre collecte.</h3>
			<div class="form-row">
			...
			<h4 class="mt-3 mb-1">2. <span id="pickDate">Ma collecte</span></h4>
			<p style="font-size:95%;">Le jour de votre collecte un picker se présentera à votre domicile sur le créneau horaire choisi et remplira avec vous le(s) sac(s) à collecter.<br/><small>Vous vous engagez à être présent durant cette période.</small></p>
			<div class="form-row">
				<div class="col-md-9 form-group">
					<label>Horaire</label>
			...
			<div id="credits-row" class="form-row d-none">
				<div class="col-12 form-group">
					<p class="mb-0" style="font-size:95%;">Créditez votre compte pour pouvoir programmer la collecte de plusieurs sacs. 1 crédit = 1 sac collecté <br><small>Les crédits sont sans limite de durée.</small></p>
				</div>
				<div class="col-md-9 form-group">
			...
			<h4 class="mt-3 mb-1">3. Mon compte</h4>
			<p style="font-size:95%;">En validant ce formulaire vous allez créer un compte Pic'Verre à partir duquel vous pourrez programmer vos prochaines collectes.<br><small> Vous allez recevoir un email permettant d'initialiser votre pot de passe.</small></p>
			<div class="form-row">
			...
			<ul class='list-group mb-4' id='list-order'>
				<li class='list-group-item' style="background:#9fcced;">
					<div class='h6'><span class='text-uppercase'>1 crédit = <strong class=''>1 sac collecté</strong></span> <span class='badge badge-pill bg-secondary text-primary'>offert</span></div>
					<span class='text-white font-weight-bold' style="font-size:85%;"><strong>Nous collectons votre premier sac gratuitement !</strong></span>
				</li>
				<li class='list-group-item pl-1' style="background:#9fcced;">
					...
					<span class='text-white font-weight-bold' style="font-size:85%;">Vous devez faire l'acquisition d'un sac Pic'Verre <strong>uniquement lors de votre première collecte</strong>. A la fin de chaque collecte le picker vous remettra un nouveau sac pour la collecte suivante. <!--<a href='https://www.pic-verre.fr/fonctionnement' target='_blank' >En savoir plus</a>--></span>
				</li>
				<li id="list-group-credits" class="list-group-item bg-info d-none">
					<div class="h6"><span class="text-uppercase"><span id="creditsNb">1</span> crédit(s)</span> <span id="creditsTotal" class="badge badge-pill bg-secondary text-primary">3€50</span></div>
					<span id="creditsLibelle" class='text-white font-weight-bold' style="font-size:85%;">3€50 par sac collecté. <strong>Vous pouvez profiter de tarifs dégressifs avec nos packs de crédits.</strong></span>
				</li>
