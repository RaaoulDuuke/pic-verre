...
$TITRE_EXEMPLE_D_IMPLEMENTATION = "EXEMPLE D'IMPLEMENTATION DE LA SOLUTION DE PAIEMENT SYSTEMPAY";
...
$INFORMATION_para1 = "Le paiement s'appuie sur l'envoi d'un formulaire de paiement en https vers l'URL de la plateforme de paiement Systempay. Ce formulaire est généré à partir du fichier conf.txt et des champs ci dessous.";
$Fichier_conf = "Fichier conf.txt";
$INFORMATION_para2 = "Avant la première utilisation vous devez impérativement renseigner les champs <b>vads_site_id</b>, <b>key</b> et <b>vads_url_return</b> du fichier <b>conf.txt</b>. Le support Systempay vous invite à lire le fichier conf.txt. Ce fichier comporte des données sensibles. <b>La sécurisation de ces données est de votre responsabilité.</b>";
...
$INFORMATION_para5 = "<b>D'autres champs sont disponibles, le support Systempay vous invite à lire la documentation liée au formulaire de paiement</b> <a href=\"https://systempay.cyberpluspaiement.com/html/Doc/Payment_Form/2.2_Guide_d_implementation_formulaire_Paiement_V2.pdf\">Consulter la documentation.</a>";
...
$Le_support_vous_invite ="<b>Le support Systempay vous invite à lire la documentation liée à l'analyse des paramètres.</b> <a href=\"https://systempay.cyberpluspaiement.com/html/Doc/Payment_Form/2.2_Guide_d_implementation_formulaire_Paiement_V2.pdf\">Consulter la documentation</a>";
?>