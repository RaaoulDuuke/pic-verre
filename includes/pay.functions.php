...
function get_Trans_id() {
	...
	$filename = "../../includes/pay.count.txt";// il faut ici indiquer le chemin du fichier.
	$fp = fopen($filename, 'r+');
	flock($fp, LOCK_EX);
...
<div id="Info">
	...
	$form= '<form name="pay_form" method="POST" action="https://paiement.systempay.fr/vads-payment/">';
